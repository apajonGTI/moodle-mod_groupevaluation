...
function xmldb_groupevaluation_upgrade($oldversion) {
     ...
     * for demonstrative purposes and to show how the groupevaluation
     * iself has been upgraded.
     *
     * For each upgrade block, the file groupevaluation/version.php
    ...
    if ($oldversion < 2007040100) {
        ...
        // Define field course to be added to groupevaluation.
        ...
        // Define field intro to be added to groupevaluation.
        $table = new xmldb_table('groupevaluation');
        ...
        // Define field introformat to be added to groupevaluation.
        $table = new xmldb_table('groupevaluation');
        ...
        upgrade_mod_savepoint(true, 2007040100, 'groupevaluation');
    }
    ...
    if ($oldversion < 2007040101) {
        ...
        // Define field timemodified to be added to groupevaluation.
        $table = new xmldb_table('groupevaluation');
        ...
        // Define index course (not unique) to be added to groupevaluation.
        $table = new xmldb_table('groupevaluation');
        ...
        upgrade_mod_savepoint(true, 2007040101, 'groupevaluation');
    }
    ...
    if ($oldversion < 2007040200) {
        ...
        upgrade_mod_savepoint(true, 2007040200, 'groupevaluation');
    }
